...
class BottomeSheetConfirmPasswordWidget extends StatefulWidget {
  const BottomeSheetConfirmPasswordWidget({
    Key? key,
  ...
  @override
  State<BottomeSheetConfirmPasswordWidget> createState() =>
      _BottomeSheetConfirmPasswordWidgetState();
}
...
class _BottomeSheetConfirmPasswordWidgetState
    extends State<BottomeSheetConfirmPasswordWidget> {
  @override
  Widget build(BuildContext context) {
    InfoForgetPassword infoForgetPassword = InfoForgetPassword(
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          TextUtiels(
            text: AppWordManger.useTheCodeSentToYouToVerifyAndAccessYourAccount,
          ...
          BlocConsumer<ConfirmForgetPasswordCubit, ConfirmForgetPasswordState>(
            listener: (context, state) {
              AuthLogic().listenerConfirmForgetPasswordPhone(
                  state, context, infoForgetPassword);
            },
                ...
                child: MainElevatedButton(
                  ...
                  onPreesed: () {
                    ...
                    if (code.isNotEmpty && code.length < 5) {
                      context
                          .read<ConfirmForgetPasswordCubit>()
                          .confirmForgetPassword(
                              phoneNumber: widget.numberPhone, code: code);
                    }
                  },
                ),
              );
